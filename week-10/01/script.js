(function () {
  ...
  function Draw() {
    ...
    // Intialize texture
    this._texture = {
      envMap: new Texture(this._gl, 0, this._program.figure.getUniformLocation("envMap"), { type: 'CUBE' })
    };
    ...
    this._gl.uniformMatrix4fv(this._program.figure.getUniformLocation("uM"), false, flatten(M));
    this._gl.uniformMatrix4fv(this._program.figure.getUniformLocation("uV"), false, flatten(V));
    ...
    // Load textures
    this._geometries.figure.setFigure(new Sphere(5));
  ...
  Draw.prototype.render = function () {
    ...
    this._gl.drawArrays(this._gl.TRIANGLES, 0, this._geometries.figure.vetricesCount);
  };
  ...
  function Texture(gl, textureIndex, uniform, options) {
    options = options || {};
    ...
    this._gl.texParameteri(this._type, this._gl.TEXTURE_MIN_FILTER, this._gl.NEAREST);
    this._gl.texParameteri(this._type, this._gl.TEXTURE_MAG_FILTER, this._gl.NEAREST);
  }

  Texture.prototype.bindUniform = function () {
    this._gl.uniform1i(this._uniform, this._index);
  };
