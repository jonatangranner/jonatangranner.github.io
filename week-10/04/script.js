...
function init() {
    ...
    program.texCube = gl.getUniformLocation(program, 'texCube');
    program.texImage = gl.getUniformLocation(program, 'texImage');
    initData()
    initTexture();
...
function initTexture() {
    
    {
        ...
        gl.uniform1i(program.texCube, cubeTexmap); 
    }

    
    {
        var normalmap = document.getElementById("normalmap");
        var normalMapTex = gl.createTexture();        
        ...
        gl.uniform1i(program.texImage, normalTexmap); 
    }
}
