(function () {
  ...
  function Draw() {
    ...
    this._texture = {
      ...
      bumpMap: new Texture(this._gl, 1, { type: '2D', repeat: true, linear: true })
    };
    ...
    this._texture.bumpMap.bindUniform(this._program.sphere.getUniformLocation("bumpMap"));
    ...
    this._texture.envMap.loadImage({
      ...
      self._texture.bumpMap.loadImage('../textures/normalmap.png', function (err) {
        if (err) throw err;
        self.onready();
      });
    });
