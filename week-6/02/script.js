...
function init() {
    ...
    initData()
    initTexture();
    var wrapM = document.getElementById("wrapMode");
    wrapM.addEventListener("click", function () {
        switch (wrapM.selectedIndex) {
            case 0:
    ...
    var filterM = document.getElementById("filterMode");
    filterM.addEventListener("click", function () {
        switch (filterM.selectedIndex) {
            case 0:
